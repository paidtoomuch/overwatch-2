...
bool    ImGui_ImplDX11_CreateDeviceObjects()
{
    ...
    // Create the vertex shader
    {
        ...
        if (bd->pd3dDevice->CreateInputLayout(local_layout, 3, g_preCompiled_pVertexShaderBlob, 876, &bd->pInputLayout) != S_OK)
        {
            //vertexShaderBlob->Release();
            return false;
        }
